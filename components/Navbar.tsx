...
const Navbar = () => {
  ...
  return (
    <nav className="flexBetween max-container w-full padding-container z-30 bg-black sticky rounded-xl top-0">
      ...
      <ul className={`md:flex h-full ml-5 hidden gap-8 ${isMenuOpen ? "flex" : "hidden"} md:items-center`}>
        ...
        <li>
          <Link href="/schedules" className="regular-16 text-white flexCenter cursor-pointer pb-1.5 transition-all hover:font-bold">
            Schedules
          </Link>
        </li>
        <li>
          <Link href="/resources" className="regular-16 text-white flexCenter cursor-pointer pb-1.5 transition-all hover:font-bold">
            Resources
          </Link>
        </li>
        <li>
          <Link href="/toDoList" className="regular-16 text-white flexCenter cursor-pointer pb-1.5 transition-all hover:font-bold">
            ToDoList
          </Link>
        </li>
        <li>
          <Link href="/tracker" className="regular-16 text-white flexCenter cursor-pointer pb-1.5 transition-all hover:font-bold">
            Tracker
          </Link>
        </li>
            ...
            <li className="flex flex-col justify-center">
              {isLoggedIn ? (
                <div className="flex flex-col">
                  <Link href="/Profile" className="text-white py-2 block hover:bg-green-700 hover:rounded-lg p-[20px] transition-all">
