...
const Track = () => {
  ...
  return (
    <div>
      <div className="mb-4 mt-10 flex mx-auto justify-center flex-col items-start max-w-[400px]">
        <label className="block text-sm font-medium text-gray-700">
          Set the Limit For Your Screen Time (hrs):
        </label>
        <input
          type="number"
          value={limitUsage}
          ...
          min="1" // or any other constraints you want to apply
        />
      </div>
